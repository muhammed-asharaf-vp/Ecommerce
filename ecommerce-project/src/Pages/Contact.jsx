        ...
        <div className="min-h-screen bg-gradient-to-br from-[#003631] to-[#002822]">
            ...
            <section className="relative py-16 bg-gradient-to-br from-[#003631] to-[#002822]">
                ...
                <div className="relative max-w-4xl mx-auto px-6 text-center">
                    <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full mb-8 border border-[#FFEDA8]/20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:border-[#FFEDA8]/30 transition-all duration-300">
                                ...
                                <div className="flex items-start space-x-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:border-[#FFEDA8]/30 transition-all duration-300">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-300">concierge@veloce.com</p>
                                ...
                                <div className="flex items-start space-x-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:border-[#FFEDA8]/30 transition-all duration-300">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-white mb-1">Boutique</h3>
                                        <p className="text-gray-300">123 Luxury Avenue</p>
                                        <p className="text-gray-400 text-sm">Kerala, India 682001</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            ...
                            <div key={index} className="p-6 rounded-lg bg-white/5 border border-white/10 hover:border-[#FFEDA8]/30 transition-all duration-300">
            ...
            <section className="py-12 bg-gradient-to-r from-[#003631] to-[#002822] border-t border-white/10">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <button 
                        ...
                        className="bg-[#FFEDA8] text-[#003631] px-8 py-3 rounded-lg font-semibold hover:bg-[#FFEDA8]/90 transition-colors duration-300 cursor-pointer"
                    >
                        Browse Collection
                    </button>
                </div>
