    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          <div className="mb-12">
            <div className="w-24 h-24 mx-auto mb-8 border-2 border-yellow-600 rounded-full flex items-center justify-center">
              <span className="text-yellow-600 text-3xl font-bold font-serif">T</span>
            </div>
            ...
            <p className="text-2xl md:text-3xl font-light tracking-widest uppercase text-gray-300">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-yellow-600 rounded-full flex justify-center">
            <div className="w-0.5 h-3 bg-yellow-600 rounded-full mt-2"></div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative group">
              <div className="absolute -top-6 -left-6 w-24 h-24 border-t border-l border-yellow-600"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 border-b border-r border-yellow-600"></div>
            ...
            <div className="lg:pl-12">
              <div className="flex items-center mb-8">
                ...
                <span className="text-yellow-600 uppercase tracking-widest text-sm font-semibold">Our Heritage</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-serif font-light text-gray-900 mb-8 leading-tight">
                Crafting <span className="text-yellow-600">Legends</span> <br />
                For Generations
              </h2>
              ...
              <div className="grid grid-cols-3 gap-8 text-center">
                <div className="group hover:transform hover:scale-105 transition-transform duration-300">
                  <div className="text-4xl font-serif text-yellow-600 mb-2 group-hover:text-yellow-700">50+</div>
                  <div className="text-gray-600 text-sm uppercase tracking-widest">Years Excellence</div>
                </div>
                <div className="group hover:transform hover:scale-105 transition-transform duration-300">
                  <div className="text-4xl font-serif text-yellow-600 mb-2 group-hover:text-yellow-700">150+</div>
                  <div className="text-gray-600 text-sm uppercase tracking-widest">Master Craftsmen</div>
                </div>
                <div className="group hover:transform hover:scale-105 transition-transform duration-300">
                  <div className="text-4xl font-serif text-yellow-600 mb-2 group-hover:text-yellow-700">75+</div>
                  <div className="text-gray-600 text-sm uppercase tracking-widest">Countries Served</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-serif font-light mb-6">The Art of Precision</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="group text-center p-12 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-all duration-500 border border-gray-700 hover:border-yellow-600/30">
                <div className="w-24 h-24 mx-auto mb-8 bg-yellow-600/10 rounded-full flex items-center justify-center group-hover:bg-yellow-600/20 transition-colors duration-300 border border-yellow-600/20">
                  {item.icon}
                </div>
                <h3 className="text-2xl font-serif mb-6 text-yellow-600">{item.title}</h3>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="w-24 h-24 mx-auto mb-12 border-2 border-yellow-600 rounded-full flex items-center justify-center">
              <span className="text-yellow-600 text-4xl font-bold font-serif">T</span>
            </div>
            <h2 className="text-6xl md:text-7xl font-serif font-light mb-8 leading-tight">
              A Legacy <span className="text-yellow-600">Perfected</span> <br />
              Through Time
            </h2>
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-2xl mx-auto">
            <div className="w-16 h-0.5 bg-yellow-600 mx-auto mb-8"></div>
            <p className="text-2xl italic text-gray-300 leading-relaxed mb-12">
