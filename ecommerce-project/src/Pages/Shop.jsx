              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-3 rounded-lg backdrop-blur-md border bg-black/80 text-gray-300 border-gray-600 hover:bg-blue-500 hover:text-white hover:scale-110 hover:shadow-xl transition-all duration-300"
                      title="View Product"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                ...
                <div className="p-6 relative">
                  ...
                  <div className="flex justify-between items-center pt-6 border-t border-gray-700/50">
                    <span className="text-3xl font-light text-gold-400">${product.price}</span>
                    ...
                    <button
                      ...
                      className={`p-4 rounded-lg bg-gradient-to-r from-gold-500 to-gold-600 text-black hover:from-gold-400 hover:to-gold-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border border-gold-300`}
