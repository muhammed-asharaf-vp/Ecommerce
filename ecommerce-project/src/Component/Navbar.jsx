    ...
    <>
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[60] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full border border-[#FFEDA8]/20">
            <div className="p-6">
              <h3 className="text-xl font-semibold text-[#003631] mb-2">
                Confirm Logout
              </h3>
              <p className="text-[#003631]/70 mb-6">
                Are you sure you want to logout? You'll need to sign in again to access your account.
              </p>
              <div className="flex gap-3 justify-end">
                <button
                  onClick={handleCancelLogout}
                  className="px-6 py-2 border border-[#003631] text-[#003631] rounded-lg hover:bg-[#003631]/5 transition-colors duration-200 font-medium"
                >
                  Cancel
                </button>
                <button
                  onClick={handleConfirmLogout}
                  className="px-6 py-2 bg-[#003631] text-[#FFEDA8] rounded-lg hover:bg-[#003631]/90 transition-colors duration-200 font-medium shadow-lg hover:shadow-xl"
                >
                  Yes, Logout
                </button>
              </div>
